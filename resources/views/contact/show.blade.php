<x-layout title="create contact">
    ...
    <form class="form">
        @if ($contact->avatar)
            <img src="{{ Storage::disk(\App\Models\Contact::DISK)->url($contact->avatar) }}"
                style="cursor: default; margin-bottom:40px;" alt=""
        ...
        <div class="group">
            ...
            <input type="text" disabled value="{{ old('gender', $contact->gender) }}" name="gender">
            </select>
        </div>
        <div class="group">
